    ...
    <div className="flex flex-col items-center min-h-screen bg-gray-50   p-8">
      ...
      <div className="w-full max-w-[350px] pt-0 pb-2 flex items-center gap-3">
        ...
        <div>
          ...
          <div className="text-xs text-gray-500">저장한 뉴스 3개</div>
        </div>
      </div>
      ...
      <div className="w-full max-w-[350px] flex gap-2 pt-2 pb-2 mb-4 overflow-x-auto">
        {categories.map((cat, index) => (
          <button
            key={cat}
            className={`px-3 py-2 rounded-full text-sm font-medium border transition ${selectedCategory === cat ? "bg-blue-700 text-white border-blue-700" : "bg-gray-100 text-gray-700 border-gray-200 hover:bg-blue-100"}`}
