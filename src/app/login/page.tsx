...
export default function LoginPage() {
  ...
  <div className="max-w-screen-sm min-h-screen mx-auto px-8 flex flex-col items-center justify-center ">
    ...
    <Button className={`bg-[#fee500] w-[220px] flex items-center gap-4 -translate-y-3 text- font-medium`} type="submit" iconPosition="left" icons= {<img src="/kakaotalk.png" alt="kakaotalk logo" className="w-[40px] h-auto" />}>카카오 로그인</Button>
    </div>
  </div>
  )
}